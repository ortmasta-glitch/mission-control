 ...
 * Uses useSyncExternalStore for React integration (same pattern as our Zustand store).
 *
 * Ported from robsannaa/openclaw-mission-control and adapted for our MC design system.
 */
...
const READ_IDS_KEY = "mc_notif_store_read_ids";
