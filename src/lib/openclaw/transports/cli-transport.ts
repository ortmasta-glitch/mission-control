/**
 * CLI transport — delegates to the openclaw binary for all operations.
 *
 ...
 * through 1:1 to the CLI utility functions with zero behavior change.
 */
...
export class CliTransport implements OpenClawTransport {
