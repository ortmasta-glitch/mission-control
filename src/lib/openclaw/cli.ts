/**
 * CLI subprocess utilities for OpenClaw.
 *
 * Provides low-level functions for running `openclaw` binary commands.
 * Used by CliTransport but can also be used directly when CLI-only
 * operation is needed.
 */
